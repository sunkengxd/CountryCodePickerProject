...
class CustomColorFragment : Fragment() {
    ...
    private fun setClickListener() {
        relativeColor1.setOnClickListener {
            setColor(
                1,
                getColor(requireContext(), R.color.color1)
            )
        }

        relativeColor2.setOnClickListener {
            setColor(
                2,
                getColor(requireContext(), R.color.color2)
            )
        }

        relativeColor3.setOnClickListener {
            setColor(
                3,
                getColor(requireContext(), R.color.color3)
            )
        }
